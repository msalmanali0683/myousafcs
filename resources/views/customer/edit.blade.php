                    ...
                    <form id="newCustomerform" class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="formValidationName" class="form-control"
                                placeholder="Enter full name........." name="formValidationName"
                                value="{{ isset($customer) ? $customer->name : '' }}" />
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="contact_number">Contact Number</label>
                            <input type="text" id="contact_number" class="form-control"
                                placeholder="Enter Mobile number ..............." name="contact_number"
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="address" class="form-control" placeholder="Enter complete address"
                                name="address" value="{{ isset($customer) ? $customer->address : '' }}" />
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#newCustomerform').submit(function(event) {
            ...
            $.ajax({
                type: 'POST',
                url: '/app/ecommerce/customer/update/' + formData.id,
                data: formData,
                dataType: 'json',
                success: function(data) {
                    ...
                    window.location.href = "{{ route('app-ecommerce-customer-all') }}";
                },
